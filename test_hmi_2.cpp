...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		HWND hCheckBox = CreateWindowW(L"button", L"LUL",
			WS_VISIBLE | WS_CHILD | BS_CHECKBOX,
			20, 20, 185, 35, hWnd, (HMENU)1,
			NULL, NULL);

		HWND hCheckBox2 = CreateWindowW(L"button", L"LUL2",
			WS_VISIBLE | WS_CHILD | BS_CHECKBOX,
			20, 50, 185, 35, hWnd, (HMENU)1,
			NULL, NULL);
	...
	case WM_COMMAND:
	{
		...
		default:
		{
			UINT checked = IsDlgButtonChecked(hWnd, 1);
